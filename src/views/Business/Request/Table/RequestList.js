...
import { getRequestBusiness, admissionRequestBusiness } from "api/axios/business";
...
export default class RequestList extends Component {
  ...
  updateRequestList = async page => {
    ...
    return getRequestBusiness({ page: p })
      .then(result => {
  ...
  admissionRequest = id => {
    return admissionRequestBusiness({ id: id })
      .then(result => this.updateRequestList())
      .catch(err => console.log(err));
  };
